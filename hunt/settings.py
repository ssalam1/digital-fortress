...
DATABASES = {
    'default': {
        ...
        'NAME': 'treasure_hunt',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '$#r&a2xk9oh5i78esg5yxuv(7z4638-&j*(0(alor36=r9b&f$'
...
FANDJANGO_SITE_URL = 'http://digitalfortress.mkti.in/'
FACEBOOK_AUTHORIZATION_REDIRECT_URL = 'http://digitalfortress.mkti.in'
